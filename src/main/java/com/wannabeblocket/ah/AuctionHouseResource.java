...
public class AuctionHouseResource {
    ...
    public Response getAll() { 
        ...
        listings.add(new Listing(new Account("Kalle"), "desc", new Date(), new Category("kläder")));
    ...
    public Response add(@FormParam("seller") String seller, @FormParam("description") String description) {
        ...
        _auctionHouse.add(new Listing(new Account("HEJ"), "DESCRIPTION", new Date(), new Category("kläder")));
        return Response.ok().build();
    }
}
